...
insert() 插入所有set后的字段
insert(Field<?> ... feilds) 插入指定set后的字段
insert(Collection<? extends Field<?>> fields) 插入指定set后的字段
...
update() 更新所有set后的字段
update(Field<?> ... feilds) 更新指定set后的字段
update(Collection<? extends Field<?>> fields) 更新指定set后的字段
